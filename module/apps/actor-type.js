...
export default class ActorTypeConfig extends FormApplication {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      title: "PERGASHA.CreatureTypeTitle",
      width: 280,
      height: "auto",
      choices: {},
      allowCustom: true,
  ...
  getData(options) {
    ...
    if (foundry.utils.getType(attr) !== "Object") attr = {
      value: (attr in CONFIG.PERGASHA.creatureTypes) ? attr : "humanoid",
      subtype: "",
      swarm: "",
      custom: ""
    };
    ...
    // Populate choices
    const types = {};
    for (let [k, v] of Object.entries(CONFIG.PERGASHA.creatureTypes)) {
      types[k] = {
    ...
    return {
      ...
      custom: {
        value: attr.custom,
        label: game.i18n.localize("PERGASHA.CreatureTypeSelectorCustom"),
        chosen: attr.value === "custom"
      },
      subtype: attr.subtype,
      swarm: attr.swarm,
      sizes: Array.from(Object.entries(CONFIG.PERGASHA.actorSizes)).reverse().reduce((obj, e) => {
        obj[e[0]] = e[1];
        return obj;
      }, {}),
