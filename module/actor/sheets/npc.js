...
export default class ActorSheet5eNPC extends ActorSheet5e {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["pergashaFoundryvtt", "sheet", "actor", "npc"],
      width: 600,
      height: 680
    });
  }
  ...
  _prepareItems(data) {
    ...
    const features = {
      weapons: { label: game.i18n.localize("PERGASHA.AttackPl"), items: [], hasActions: true, dataset: { type: "weapon", "weapon-type": "natural" } },
      actions: { label: game.i18n.localize("PERGASHA.ActionPl"), items: [], hasActions: true, dataset: { type: "feat", "activation.type": "action" } },
      passive: { label: game.i18n.localize("PERGASHA.Features"), items: [], dataset: { type: "feat" } },
      equipment: { label: game.i18n.localize("PERGASHA.Inventory"), items: [], dataset: { type: "loot" } }
    };
