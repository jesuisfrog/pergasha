...
export default class DamageRoll extends Roll {
  ...
  configureDamage() {
    ...
    if (this.options.powerfulCritical && (flatBonus > 0)) {
      ...
      this.terms.push(new NumericTerm({ number: flatBonus }, { flavor: game.i18n.localize("PERGASHA.PowerfulCritical") }));
    }
  ...
  toMessage(messageData = {}, options = {}) {
    ...
    if (this.isCritical) {
      const label = game.i18n.localize("PERGASHA.CriticalHit");
    ...
    return new Promise(resolve => {
      new Dialog({
        ...
        buttons: {
          ...
          normal: {
            label: game.i18n.localize(allowCritical ? "PERGASHA.Normal" : "PERGASHA.Roll"),
